...
import { Home, Briefcase, Code, Sparkles, Menu, X, GraduationCap } from 'lucide-react';
    ...
    return (
        <nav className={navClasses}>
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex justify-between items-center w-full">
                ...
                <div className="flex-shrink-0 font-[family-name:var(--ai-font)] font-bold text-[var(--ai-text)]">
                </div>
